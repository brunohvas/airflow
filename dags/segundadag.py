...
#exemplo de dag usando paralelismo entre as tasks

dag = DAG('segunda_dag', description='segunda dag exemplo curso',
...
task1 >> [task2, task3] #[ ] task executando em paralelo
